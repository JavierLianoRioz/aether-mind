...
4.  **Generación de Informe**:
    - **Ubicación Obligatoria**: Todo contenido generado debe ir en `aether-mind/docs/libraries`.
    - **Estructura de Archivos**:
      - **Recurso Simple**: Crea un único archivo markdown: `aether-mind/docs/libraries/<recurso_snake_case>.md`.
      - **Recurso Complejo/Extenso**: Si hay muchos ejemplos o secciones distintas, crea una subcarpeta: `aether-mind/docs/libraries/<recurso_snake_case>/`.
        - Ejemplo: `aether-mind/docs/libraries/astrojs/README.md`, `aether-mind/docs/libraries/astrojs/routing_examples.md`.
