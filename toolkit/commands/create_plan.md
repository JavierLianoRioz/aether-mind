...
1.  **Analizar la Tarea**:
    ...
    - **Revisión de Documentación**: Verifica si existen carpetas o archivos relevantes en `aether-mind/docs/libraries` para las tecnologías involucradas.
    - **Revisión de Reglas**: Verifica `aether-mind/docs/general_rules` y `aether-mind/docs/project_rules` para aplicar estándares y normativas del proyecto.
...
3.  **Estructura del Plan**:
    ...
    - [Nombre Tecnología]: [Enlace a aether-mind/docs/libraries/...] (Si existe)
    - [Nombre Tecnología]: **MISSING DOCUMENTATION** (Si debería existir pero no está en aether-mind/docs/libraries)

    ## Relevant Rules

    [Revisar `aether-mind/docs/general_rules` y `aether-mind/docs/project_rules` y listar las reglas aplicables]

    - [Nombre Regla]: [Enlace a aether-mind/docs/..._rules/...]
